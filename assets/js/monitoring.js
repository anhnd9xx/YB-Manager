...
const MON_MSG = {
  ...
  BROWSER_NOT_RUNNING: 'Chrome chưa chạy', DEBUG_PORT_NOT_LISTENING: 'Cổng kiểm tra trình duyệt chưa sẵn sàng',
  DEVTOOLS_HTTP_UNAVAILABLE: 'Không kết nối được trình duyệt',
  CDP_UNAVAILABLE: 'Không kết nối được trình duyệt', CDP_WEBSOCKET_FAILED: 'Không kết nối được trình duyệt',
  CDP_COMMAND_TIMEOUT: 'Trình duyệt phản hồi chậm', CDP_DISCONNECTED: 'Mất kết nối với trình duyệt',
